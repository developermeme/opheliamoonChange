...
function TermsOfService() {
  return (
    <div className="policy-content">
      <div className="policy-head u-h3">Ophelia-moonia-moon Terms of Service</div>
      ...
      <ul>
        ...
        <li>
          ...
          “Us” or “Our” in this Agreement) refers to Ophelia-moon.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Ophelia-moon, accessible from
      ...
      <ul>
        <li>By email : contact@ophelia-moon.in</li>
        <li>By visiting this page on our website : https://Ophelia-moon.in/</li>
